...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-paper-texture">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-40 bg-brand-navy hover:bg-brand-gold text-white p-3 rounded-full shadow-2xl transition-all duration-300 transform border border-white/10 ${
      ...
      >
        ...
        <span className="max-w-0 overflow-hidden group-hover:max-w-xs group-hover:ml-3 transition-all duration-500 whitespace-nowrap text-xs font-black uppercase tracking-widest">
          Inscripciones
        </span>
      </a>
    </div>
